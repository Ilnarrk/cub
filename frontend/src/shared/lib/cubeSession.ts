...
const EMPTY_SESSION: CubeSession = {
...
export function loadCubeSession(): CubeSession {
  try {
    ...
    return {
      visualFacelets:
        typeof parsed.visualFacelets === "string"
          ? parsed.visualFacelets
          : EMPTY_SESSION.visualFacelets,
      solverFacelets:
        typeof parsed.solverFacelets === "string" ? parsed.solverFacelets : "",
    };
  } catch {
