        ...
        <div className="mx-auto flex h-[72px] max-w-[1440px] items-center justify-between px-4 sm:px-6 lg:px-10">
          <div className="flex items-center gap-3">
            <div className="relative grid h-9 w-9 grid-cols-2 gap-[3px] rounded-xl border border-white/10 bg-white/[0.07] p-2 shadow-[0_0_30px_rgba(124,92,255,.25)]">
              ...
              <span className="rounded-[2px] bg-[#00c5ff]" />
              <span className="rounded-[2px] bg-[#ffce3a]" />
              <span className="rounded-[2px] bg-[#ff5b65]" />
            </div>
            <div>
              <h1 className="text-[15px] font-bold tracking-[-.02em]">
                Cube Studio
              </h1>
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/[.05] px-3 py-2 text-xs font-semibold text-white/70 transition hover:border-violet-400/30 hover:bg-violet-400/10 hover:text-white"
          >
            <BookOpen size={16} />
            <span className="hidden sm:inline">Как собирать</span>
          </button>
        </div>
      </header>
